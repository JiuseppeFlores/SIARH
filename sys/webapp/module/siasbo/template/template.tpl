...
<head>
    ...
    {* {if $miga.smodulo.carpeta == 'geovisor'} *}
    <!--begin::Open Layers Styles -->
    <!-- <link href="js/OpenLayers/4.6.4/css/ol.css" rel="stylesheet" type="text/css" /> -->
    <link rel="stylesheet" href="js/OpenLayers/3.20.1/css/ol.css" type="text/css">
    <!-- <link href="js/OpenLayers/3.5.0/css/ol.css" rel="stylesheet" type="text/css" /> -->
    <!-- <link href="js/OpenLayers/3.5.0/plugins/ol3-layerswitcher-master/src/ol3-layerswitcher.css" rel="stylesheet" type="text/css" /> -->
    <link href="js/OpenLayers/3.20.1/plugins/ol-ext-master/dist/ol-ext.min.css" rel="stylesheet" type="text/css" />
...
<!--begin::Canvas2image -->
<script src="js/jQuery.printarea/canvas2image.js" type="text/javascript"></script>
<!--end::Canvas2image -->

<!--begin::jquery.printarea -->
<script src="js/jQuery.printarea/jquery.printarea.js" type="text/javascript"></script>
<!--end::jquery.printarea -->

<!--begin::printThis -->
<script src="js/jQuery.printarea/printThis.js" type="text/javascript"></script>
<!--end::printThis -->

{* {if $miga.smodulo.carpeta == 'geovisor'} *}
 <!-- <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3&key=
AIzaSyBqv2Y6BHPamq9Qa-hpt2EsQfYWpXzxFxo
"></script> -->
 <!-- <script src="js/OpenLayers/3.5.0/plugins/ol3-google-maps/ol3gm.js" type="text/javascript"></script> -->
<!--begin::OpenLayers -->
<script src="js/OpenLayers/3.20.1/build/ol.js" type="text/javascript"></script>
<!-- <script src="js/OpenLayers/3.5.0/build/ol.js" type="text/javascript"></script> -->
<!-- <script src="js/OpenLayers/3.5.0/plugins/ol3-layerswitcher-master/src/ol3-layerswitcher.js" type="text/javascript"></script> -->
<script src="js/OpenLayers/3.20.1/plugins/ol-ext-master/dist/ol-ext.min.js" type="text/javascript"></script>
<!--end::OpenLayers -->

<!--begin::proj4-->
<script src="js/proj4/2.3.14/proj4.js" type="text/javascript"></script>
<!--end::proj4-->

<!--begin::jspdf-->
<script src="js/jsPDF-master/dist/jspdf.min.js" type="text/javascript"></script>
<!--end::jspdf-->
