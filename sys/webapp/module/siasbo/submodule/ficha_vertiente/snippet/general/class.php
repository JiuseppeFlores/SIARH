...
class Snippet extends Table {
    ...
    function procesa_datos($que_form,$rec,$accion="new"){
        ...
        switch($que_form){
            case 'item':
                 ...
                 */
                if ($accion=="new"){
                    $dato_resultado["tipo"]=4; // de tipo pozo
                }
    ...
    function get_nuevo_codigo($deptoId, $codigo_macrocuenca){
        ...
        //$nuevo_codigo = $codigo_ine[0]['codigo_ine'].'-'.$codigo_macrocuenca[0]['codigo_pfafs'].'-C-';
        $nuevo_codigo = $codigo_macrocuenca[0]['codigo_pfafs'].'-'.$codigo_ine[0]['codigo_ine'].'-C-';
