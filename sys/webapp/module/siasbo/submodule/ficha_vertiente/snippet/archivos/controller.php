...
switch($accion){
    ...
    case 'getItemList':
        $respuesta = $subObjItem->get_item_datatable_Rows($captacionId);
    ...
    case 'itemUpdate':
        $smarty->assign("captacionId", $captacionId);
        $smarty->assign("id", $id);
    ...
    case 'itemDelete':
        $res = $subObjItem->item_delete($id, $captacionId);
        $core->print_json($res);
        break;

    case 'itemDescarga':
        $subObjItem->get_file($id, $captacionId);
        break;
