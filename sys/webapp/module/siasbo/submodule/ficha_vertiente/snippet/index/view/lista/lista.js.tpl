...
<script>
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return botonedit+botondelete; //+botonreadonly;
                        },
                    },
                    {
                        targets: [ 1 ],
    ...
    //Seccion Importacion de Datos desde Excel     //FALTA ADAPTAR ESTE CODIGO A VERTIENTE
    ...
    $("#btn_enviar").click(function(){
        //alert('{/literal}{$getModule}{literal}&accion=enviarArchivo');
...
//----------------Permisos--------------------------------------------
    ...
    function permisos_usuario(){
        ...
        jQuery.ajax({
            url: '{/literal}{$getModule}{literal}&accion=obtenerPermisos&perpozo=captación superficial', //&perpozo=pozo ya no es necesario
            //data: data,
            cache: false,
            contentType: false,
            processData: false,
