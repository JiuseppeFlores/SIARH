...
class Subcatalogo extends Table{
    ...
    public function conf_catalog_datos_general(){
        ...
        $this->addCatalogList($this->tabla["c_geofisica_dev_lineabase"],"lineabase","","","","itemId","","");
        $this->addCatalogList($this->tabla["o_departamento"],"departamento","","","","itemId","","");
        $this->addCatalogList($this->tabla["c_pozo_general_epsas"],"epsas","","","","itemId","","");
        $this->addCatalogList($this->tabla["c_acuifero"],"acuifero","","","","itemId","","");
