<div class="m-portlet__head">
    <div class="m-portlet__head-caption">
        <div class="m-portlet__head-title">
            <h3 class="m-portlet__head-text">Lista de redes de Monitoreo</h3>
        </div>
    </div>
    <div class="m-portlet__head-tools">
        <ul class="m-portlet__nav">
            <li class="m-portlet__nav-item">
                {* <button class="btn btn-focus m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" id="btn_busqueda_especifica" rel="new">
                    <span><i class="fa fa-search"></i><span id="sp_label">&nbsp;Mostrar busqueda especifica</span></span>
                </button>&nbsp; *}
                ...
                <a href="#" class="btn btn-focus m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" id="btn_update" rel="new">
					<span><i class="fa fa-plus"></i><span>&nbsp;Nueva Red de Monitoreo</span></span>
                </a>
            </li>
