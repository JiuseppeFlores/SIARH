...
<script>
    ...
    var snippet_datatable_list_seguimiento = function () {
        ...
        var exporta_titulo = "SIASBO - LISTA DATOS DE REDES DE MONITOREO (POZOS Y MANANTIALES)";
        var exporta_columnas = [':visible :not(.noExport)'];

        var initTable = function() {
            // begin first table
            table_list_seguimiento = $('#lista_redes_items').DataTable({

                initComplete: function(settings, json) {
                    $('#lista_redes_items').removeClass('m--hide');
                },
                responsive: true,
                keys: {
                    blurable: false,
