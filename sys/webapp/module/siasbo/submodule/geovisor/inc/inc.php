...
// Configuracion para acceso a pentaho server
$CFGm->pentaho["url"] = $CFG->pentaho["url"];
$CFGm->pentaho["carpeta"] = ":siarh:siasbo:";
$CFGm->pentaho["user"] = "siasbo";
$CFGm->pentaho["password"] = "ab1u.0932D4";