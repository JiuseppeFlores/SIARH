...
<script>
    ...
    var mapa, vista, puntosPozo, puntosManantial, puntosGeofisica;
    var mapaBing;
    ...
    var mapaAcuiferos;
    var mapaGuadalquivirGeologia50000;
    var mapaGuadalquivirLineasGeologicas;
    var mapaOruroSuelos;
    var mapaCochabambaValleAltoSuelos;
    ...
    var snippet_mapa = function () {
        ...
        var lnk_mapa_busqueda = $('#lnk_mapa_busqueda');
        var div_mapa = $('#mapa');
        var bnd_busqueda = 0;
        var txt_busca_punto = $('#txt_busca_punto');
        var btn_busca_punto = $('#btn_busca_punto');
        ...
        var initMapa = function() {
            ...
            mapaHidrogeologia = new ol.layer.Image({
                ...
                source: new ol.source.ImageWMS({
                    ...
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        'FORMAT': 'image/png',
                        'VERSION': '1.1.1',  
                        STYLES: '',
            ...
            mapaDepartamental = new ol.layer.Vector({
                ...
                source: new ol.source.Vector({
                    crossOrigin: 'anonymous',
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=siasbo:departamento&outputFormat=application%2Fjson',
            ...
            var estilosMacrocuencas = new ol.style.Style({
                fill: new ol.style.Fill({
                    color: [255, 255, 255, 0]
                }),
                stroke: new ol.style.Stroke({
            ...
            mapaMacrocuencas = new ol.layer.Vector({
                ...
                source: new ol.source.Vector({
                    format: new ol.format.GeoJSON(),
                    crossOrigin: 'anonymous',
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=siasbo:macrocuencas&outputFormat=application%2Fjson'
                }),
                visible: false,
                style: estilosMacrocuencas
            });
            ...
            var estilosMunicipios = new ol.style.Style({
                fill: new ol.style.Fill({
                    color: [255, 255, 255, 0]
                }),
                stroke: new ol.style.Stroke({
            ...
            mapaMunicipios = new ol.layer.Vector({
                ...
                source: new ol.source.Vector({
                    format: new ol.format.GeoJSON(),
                    crossOrigin: 'anonymous',
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=siasbo:municipios&outputFormat=application%2Fjson'
                }),
                visible: false,
                style: estilosMunicipios
            });
            ...
            /*mapaGeologia = new ol.layer.Tile({
                id: 'geologia',
                title: 'Geología',
                source: new ol.source.TileWMS({
                    url: 'http://sig01.mmaya.gob.bo/geoserver/siasbo/wms',
                    params: {'LAYERS': 'siasbo:geologia'},
                    crossOrigin: 'anonymous'
                }),
                visible: false
            });*/

            var estilosCuencaEstra25 = new ol.style.Style({
                fill: new ol.style.Fill({
                    color: [255, 255, 255, 0]
                }),
                stroke: new ol.style.Stroke({
            ...
            mapaCuencaEstra25 = new ol.layer.Vector({
                ...
                source: new ol.source.Vector({
                    format: new ol.format.GeoJSON(),
                    crossOrigin: 'anonymous',
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=siasbo:cuenca_estra_25&outputFormat=application%2Fjson'
                }),
                visible: false,
                style: estilosCuencaEstra25
            });
            ...
            /*mapaAcuiferos = new ol.layer.Vector({
                id: 'acuifero',
                title: 'Acuíferos',
                source: new ol.source.Vector({
                    format: new ol.format.GeoJSON(),
                    crossOrigin: 'anonymous',
                    url: 'http://sig01.mmaya.gob.bo/geoserver/siasbo/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=siasbo:acuiferos&outputFormat=application%2Fjson'
                }),
                visible: false,
                style: estilosBaseMapa
            });*/

            mapaGuadalquivirLineasGeologicas = new ol.layer.Image({
                id: 'guadal_linea_geologica',
                title: 'Guadalquivir - Líneas Geológicas',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:guadalquivir_lineas_geologicas',
                    }
                }),
                visible: false
            });

            mapaGuadalquivirGeologia50000 = new ol.layer.Image({
                id: 'guadal_geologia_50000',
                title: 'Guadalquivir - Geología 50000',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:guadalquivir_geologia_50000',
                    }
                }),
                visible: false
            });

            mapaOruroSuelos = new ol.layer.Image({
                id: 'oruro_suelos',
                title: 'Oruro - Suelos',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ...
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:oruro_suelos',
                    }
                }),
                visible: false
            });

            mapaCochabambaValleAltoSuelos = new ol.layer.Image({
                id: 'cocha_valle_alto_suelos',
                title: 'Cochabamba, Valle Alto - Suelos',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:cochabamba_valle_alto_suelos',
                    }
                }),
                visible: false
            });
            ...
            var mapasSiasbo = new ol.layer.Group({
                title: 'Mapas Siasbo',
                layers: [
                    mapaCochabambaValleAltoSuelos,
                    mapaOruroSuelos,
                    mapaGuadalquivirGeologia50000,
                    mapaGuadalquivirLineasGeologicas,
                    mapaGeologia,
                    mapaHidrogeologia,
                    mapaMacrocuencas,
                    mapaAcuiferos,
            ...
            var estilosBaseMapaIsolineas = new ol.style.Style({
                fill: new ol.style.Fill({
                    color: [255, 255, 255, 0]
                }),
                stroke: new ol.style.Stroke({
            ...
            var mapaPurapuraniIsolineasSodio = new ol.layer.Image({
                id: 'purapurani_isolineas_sodio',
                title: 'Purapurani - Sodio',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:purapurani_isolineas_sodio',
                    }
                }),
                visible: false
            });

            var mapaScIsolineasCalcio = new ol.layer.Image({
                id: 'sc_isolineas_calcio',
                title: 'Santa Cruz - Calcio',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:sc_isolineas_calcio',
                    }
                }),
                visible: false
            });

            var mapaScIsolineasCloruro = new ol.layer.Image({
                id: 'sc_isolineas_cloruro',
                title: 'Santa Cruz - Cloruro',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'http://sig01.mmaya.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:sc_isolineas_cloruro',
                    }
                }),
                visible: false
            });

            var mapaScIsolineasSodio = new ol.layer.Image({
                id: 'sc_isolineas_sodio',
                title: 'Santa Cruz - Sodio',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:sc_isolineas_sodio',
                    }
                }),
                visible: false
            });

            var mapaScPiezometrico = new ol.layer.Image({
                id: 'sc_piezometrico',
                title: 'Santa Cruz - Piezométrico',
                source: new ol.source.ImageWMS({
                    crossOrigin: 'anonymous',
                    ratio: 1,
                    url: 'https://sig01.siarh.gob.bo/geoserver/siasbo/wms',
                    params: {
                        ...
                        'VERSION': '1.1.1',  
                        STYLES: '',
                        LAYERS: 'siasbo:sc_piezometrico',
                    }
                }),
                visible: false
            });

            var mapasIsolineasSiasbo = new ol.layer.Group({
                title: 'Mapas de Isolíneas - Piezométrico',
                layers: [
                    mapaScPiezometrico,
                    mapaScIsolineasSodio,
                    mapaScIsolineasCloruro,
                    mapaScIsolineasCalcio,
                    mapaPurapuraniIsolineasSodio
                ]
            });
            ...
            var estilosPuntosSobrepuestos = function(feature, resolution) {
                var datosFeature = feature.getProperties();
                return [
                    new ol.style.Style({
                        text: new ol.style.Text({
                            textAlign: 'left',
                            textBaseline: 'middle',
                            text: datosFeature.tipoNombre+' '+datosFeature.itemId,
                            fill: new ol.style.Fill({
                                color: '#fff'
                            }),
                            stroke: new ol.style.Stroke({
            ...
            puntosSobrepuestos = new ol.layer.Vector({
                source: new ol.source.Vector(),
                map: mapa,
                style: estilosPuntosSobrepuestos,
                visible: false
            });
            ...
            conmutadorCapas = new ol.control.LayerSwitcher({
                tipLabel: 'Leyenda'
            });
            ...
            mapa.on('singleclick', function(browserEvent) {
                popupPunto.hide();
                ...
                mapa.forEachFeatureAtPixel(pixel, function(feature, layer) {
                    ...
                    if (contador == 1) {
                        ...
                        switch(layer.get('id')) {
                            case 'departamento':
                                var datos = feature.getProperties();
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Departamento:</strong> '+datos.departamen+'<br><strong>Código INE:</strong> '+datos.cod_ine;
                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                                break;

                            case 'municipio':
                                var datos = feature.getProperties();
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Municipio:</strong> '+datos.municipio+'<br><strong>Provincia:</strong> '+datos.provincia+'<br><strong>Departamento:</strong> '+datos.departamen+'<br><strong>Código INE:</strong> '+datos.cod_ine;
                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                                break;
                            ...
                            case 'cuenca25':
                                var datos = feature.getProperties();
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Cuenca estratégica:</strong> '+datos.nombre+'<br><strong>Superficie (km<sup>2</sup>):</strong> '+datos.sup_km2;
                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                                break;
                            ...
                            case 'macrocuenca':
                                var datos = feature.getProperties();
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Macrocuenca:</strong> '+datos.NOMBRE_N1+'<br><strong>Superficie (km<sup>2</sup>):</strong> '+datos.SUP_N1+'<br><strong>Tipo:</strong> '+datos.TIPO_UH+'<br><strong>Categoría:</strong> '+datos.CATEGORIA;
                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                                break;
                            ...
                            case 'pozo':
                                ...
                                var id = feature.get('features')[0].get('itemId');
                                var content = '<div class="ol-popup"><h5>'+feature.get('features')[0].get('tipoNombre')+' [ID: '+feature.get('features')[0].get('itemId')+']</h5><p><strong>Código:</strong> '+feature.get('features')[0].get('codigo')+'<br><strong>Nombre:</strong> '+feature.get('features')[0].get('nombre')+'<br>';

                                $.get(url, function(respuesta) {
                                    if (respuesta != 0) {
                                        content += '<strong>EPSA:</strong>&nbsp;'+respuesta[0].epsa+'<br><strong>Propósito:</strong>&nbsp;'+respuesta[0].proposito+'<br><strong>Uso:</strong>&nbsp;'+respuesta[0].uso+'<br><strong>Datos calidad:</strong>&nbsp;'+respuesta[0].calidad+'<br><strong>Datos isotópico:</strong>&nbsp;'+respuesta[0].isotopico+'<br><strong>Acuífero:</strong>&nbsp;'+respuesta[0].acuifero+'<br>';
                                    }
                                    ...
                                    if (respuesta[0].diseno == 'Si') {
                                      content += '<a href="#" onclick="graficar_diseno('+id+');">VER DISEÑO DE CONSTRUCCIÓN</a><br>';
                                    }

                                    if (respuesta[0].litologia == 'Si') {
                                      content += '<a href="#" onclick="graficar_columnalitologica('+id+');">VER COLUMNA LITOLÓGICA</a><br>';
                                    }

                                    if (respuesta[0].caudal == 'Si') {
                                      content += '<a href="#" onclick="graficar_caudal('+id+');">VER GRAFICA DE CAUDAL</a><br>';
                                    }

                                    if (respuesta[0].abatimiento == 'Si') {
                                      content += '<a href="#" onclick="graficar_abatimiento('+id+');">VER GRAFICA DE ABATIMIENTO</a><br>';
                                    }

                                    if (respuesta[0].escalon == 'Si') {
                                      content += '<a href="#" onclick="graficar_escalon('+id+');">VER GRAFICA DE ESCALONES</a><br>';
                                    }

                                    if (respuesta[0].recuperacion == 'Si') {
                                      content += '<a href="#" onclick="graficar_recuperacion('+id+');">VER GRAFICA DE RECUPERACION</a><br>';
                                    }    
                            ...
                            case 'geofisica':
                                ...
                                content += '<a href="?module=siasbo&smodule=ficha_geofisica&accion=itemUpdate&type=update&id='+id+'" target="_blank">EDITAR FICHA</a><br>';

                                content += '<a href="?module=siasbo&smodule=geovisor&accion=reportes_getFichaGeoSev&pozoId='+id+'" target="_blank">IMPRIMIR FICHA SEV</a><br>';

                                content += '<a href="?module=siasbo&smodule=geovisor&accion=reportes_getFichaGeoTomografia&pozoId='+id+'" target="_blank">IMPRIMIR FICHA TOMOGRAFÍA</a><br>';
                            ...
                            case 'manantial':
                                ...
                                $.get(url, function(respuesta) {
                                    ...
                                    content += '<a href="?module=siasbo&smodule=ficha_manantial&accion=itemUpdate&type=update&id='+id+'" target="_blank">EDITAR FICHA</a><br>';

                                    content += '<a href="?module=siasbo&smodule=geovisor&accion=reportes_getFichaManantial&manantialId='+id+'" target="_blank">IMPRIMIR FICHA</a>';
                              ...
                              var content = '<div class="ol-popup"><h5>'+feature.get('features')[0].get('tipoNombre')+' [ID: '+feature.get('features')[0].get('itemId')+']</h5><p><strong>Código:</strong> '+feature.get('features')[0].get('codigo')+'<br><strong>Nombre:</strong> '+feature.get('features')[0].get('nombre')+'<br>';
                                ...
                                switch(feature.get('features')[0].get('tipo')) {
                                    ...
                                    case 2:
                                        ...
                                        //content += '<a href="?module=siasbo&smodule=geovisor&accion=getFicha&reporte_file=geofisica_sev&id='+id+'" target="_blank">IMPRIMIR FICHA GEOFÍSICA SEV</a><br>';

                                        //content += '<a href="?module=siasbo&smodule=geovisor&accion=getFicha&reporte_file=geofisica_tomografia&id='+id+'" target="_blank">IMPRIMIR FICHA GEOFÍSICA TOMOGRAFÍA</a><br>';
                                    ...
                                    case 3:
                                        $.get(url, function(respuesta) {
                                            ...
                                            //content += '<a href="?module=siasbo&smodule=geovisor&accion=getFicha&reporte_file=manantial&id='+id+'" target="_blank">IMPRIMIR FICHA MANANTIAL</a>';
                ...
                // Muestra atributos de mapas de tipo Tile/Image
                if (tipoMapa == 0) {
                    var resolucionVista = vista.getResolution();
                    var proyeccionVista = vista.getProjection();

                    if (mapaGeologia.getVisible()) {
                        var sourceMapa = mapaGeologia.getSource();
                        var url = sourceMapa.getGetFeatureInfoUrl(
                            browserEvent.coordinate,
                            resolucionVista,
                            proyeccionVista,
                        ...
                        $.get(url, function(respuesta) {
                            if (respuesta.features.length > 0) {
                                var propiedades = respuesta.features[0].properties;
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Región morfológica:</strong> '+propiedades.REG_MORFO+'<br><strong>Periodo:</strong> '+propiedades.PERIODO+'<br><strong>Descripción:</strong> '+propiedades.DESCRIPCIO;

                                content += '<br><a href="./module/siasbo/submodule/geovisor/snippet/metadatos/geologia.docx" target="_blank">DESCARGAR METADATOS</a>';
                    ...
                    } else if (mapaHidrogeologia.getVisible()) {
                        var sourceMapa = mapaHidrogeologia.getSource();
                        var url = sourceMapa.getGetFeatureInfoUrl(
                            browserEvent.coordinate,
                            resolucionVista,
                            proyeccionVista,
                        ...
                        $.get(url, function(respuesta) {
                            if (respuesta.features.length > 0) {
                                var propiedades = respuesta.features[0].properties;
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Unidad:</strong> '+propiedades.UNIDAD+'<br><strong>Periodo:</strong> '+propiedades.PERIODO+'<br><strong>Descripción acuífero:</strong> '+propiedades.DESCRIP_AC;

                                content += '<br><a href="./module/siasbo/submodule/geovisor/snippet/metadatos/hidrogeologia.docx" target="_blank">DESCARGAR METADATOS</a>';

                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                            }
                        });
                    } else if (mapaGuadalquivirGeologia50000.getVisible()) {
                        var sourceMapa = mapaGuadalquivirGeologia50000.getSource();
                        var url = sourceMapa.getGetFeatureInfoUrl(
                            browserEvent.coordinate,
                            resolucionVista,
                            proyeccionVista,
                        ...
                        $.get(url, function(respuesta) {
                            if (respuesta.features.length > 0) {
                                var propiedades = respuesta.features[0].properties;
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Estrat.:</strong> '+propiedades.ESTRAT+'<br><strong>Descrip. Estrat.:</strong> '+propiedades.DESCR_ESTR+'<br><strong>Descripción:</strong> '+propiedades.DESCRIPCIO;

                                content += '<br><a href="./module/siasbo/submodule/geovisor/snippet/metadatos/guadalquivir.docx" target="_blank">DESCARGAR METADATOS</a>';

                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                            }
                        });
                    } else if (mapaOruroSuelos.getVisible()) {
                        var sourceMapa = mapaOruroSuelos.getSource();
                        var url = sourceMapa.getGetFeatureInfoUrl(
                            browserEvent.coordinate,
                            resolucionVista,
                            proyeccionVista,
                        ...
                        $.get(url, function(respuesta) {
                            if (respuesta.features.length > 0) {
                                var propiedades = respuesta.features[0].properties;
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Simbología:</strong> '+propiedades.Simbologí+'<br><strong>Ar_Li_Arc1:</strong> '+propiedades.Prof1_cm+'<br><strong>Ar_Li_Arc1:</strong> '+propiedades.Ar_Li_Arc1+'<br><strong>Prof2_cm:</strong> '+propiedades.Prof2_cm+'<br><strong>Ar_Li_Arc2:</strong> '+propiedades.Ar_Li_Arc2+'<br><strong>Prof3_cm:</strong> '+propiedades.Prof3_cm+'<br><strong>Ar_Li_Arc3:</strong> '+propiedades.Ar_Li_Arc3+'<br><strong>Prof4_cm:</strong> '+propiedades.Prof4_cm+'<br><strong>Ar_Li_Arc4:</strong> '+propiedades.Ar_Li_Arc4+'<br><strong>Prof5_cm:</strong> '+propiedades.Prof5_cm+'<br><strong>Ar_Li_Arc5:</strong> '+propiedades.Ar_Li_Arc5+'<br><strong>Prof6_cm:</strong> '+propiedades.Prof6_cm+'<br><strong>Ar_Li_Arc6:</strong> '+propiedades.Ar_Li_Arc6;

                                content += '<br><a href="./module/siasbo/submodule/geovisor/snippet/metadatos/suelos_oruro.docx" target="_blank">DESCARGAR METADATOS</a>';

                                content += '</p></div>';
                                popupPunto.show(coordinate, content);
                            }
                        });
                    } else if (mapaCochabambaValleAltoSuelos.getVisible()) {
                        var sourceMapa = mapaCochabambaValleAltoSuelos.getSource();
                        var url = sourceMapa.getGetFeatureInfoUrl(
                            browserEvent.coordinate,
                            resolucionVista,
                            proyeccionVista,
                        ...
                        $.get(url, function(respuesta) {
                            if (respuesta.features.length > 0) {
                                var propiedades = respuesta.features[0].properties;
                                var content = '<div class="ol-popup" style="background-color: #202233; color: #ffffff;"><p><strong>Serie:</strong> '+propiedades.SERIE+'<br><strong>Símbolo Cartográfico:</strong> '+propiedades.SÍMB_CART+'<br><strong>Textura:</strong> '+propiedades.TEXTURA+'<br><strong>Prof1_cm:</strong> '+propiedades.Prof1_cm+'<br><strong>Ar_Li_Arc1:</strong> '+propiedades.Ar_Li_Arc1+'<br><strong>Prof2_cm:</strong> '+propiedades.Prof2_cm+'<br><strong>Ar_Li_Arc2:</strong> '+propiedades.Ar_Li_Arc2+'<br><strong>Prof3_cm:</strong> '+propiedades.Prof3_cm+'<br><strong>Ar_Li_Arc3:</strong> '+propiedades.Ar_Li_Arc3+'<br><strong>Prof4_cm:</strong> '+propiedades.Prof4_cm+'<br><strong>Ar_Li_Arc4:</strong> '+propiedades.Ar_Li_Arc4+'<br><strong>Prof5_cm:</strong> '+propiedades.Prof5_cm+'<br><strong>Ar_Li_Arc5:</strong> '+propiedades.Ar_Li_Arc5+'<br><strong>Prof6_cm:</strong> '+propiedades.Prof6_cm+'<br><strong>Ar_Li_Arc6:</strong> '+propiedades.Ar_Li_Arc6;

                                content += '<br><a href="./module/siasbo/submodule/geovisor/snippet/metadatos/suelos_valle_alto.docx" target="_blank">DESCARGAR METADATOS</a>';
        ...
        var get_busqueda_punto = function(txt_busca_punto) {
            $.post("{/literal}{$getModule}{literal}&accion=getBuscaPunto"
                , {dato: txt_busca_punto}
                , function (respuesta, textStatus, jqXHR) {
                    if (respuesta != 0) {
                        puntosSobrepuestos.setSource(null);
                        var nuevoVector = new ol.source.Vector();
                        var format = new ol.format.GeoJSON();
                        var features = format.readFeatures(respuesta, {
                            featureProjection: 'EPSG:3857'
                        ...
                        nuevoVector.addFeatures(features);
                        puntosSobrepuestos.setSource(nuevoVector);
                        puntosSobrepuestos.setVisible(true);
                        ...
                        swal('Advertencia!','No existen resultados para la búsqueda.','warning');
                        puntosSobrepuestos.setSource(null);
                        puntosSobrepuestos.setVisible(false);
                    }
                }
                , 'json');
        };
        ...
        var mostrarFormBusqueda = function() {
            $('#window_search').fadeIn();
        };

        var ocultarFormBusqueda = function() {
            $('#window_search').hide();
        };
        ...
        var handle_get_components = function() {
            ...
            lnk_mapa_busqueda.click(function(){
                if (bnd_busqueda == 0) {
                    mostrarFormBusqueda();
                    bnd_busqueda = 1;
                } else {
            ...
            btn_busca_punto.click(function() {
                if (txt_busca_punto.val() != '') {
                    get_busqueda_punto(txt_busca_punto.val());
                } else {
                    swal('Advertencia!','Escriba el nombre o código del punto que desea buscar.','warning');
                }
            });
        };
    ...
    var graficar_escalon = function(id) {
        var url = "{/literal}{$getModule}{literal}&accion=graficas_getGraficaEscalon&id="+id;
    ...
    var graficar_recuperacion = function(id) {
        var url = "{/literal}{$getModule}{literal}&accion=graficas_getGraficaRecuperacion&id="+id;
