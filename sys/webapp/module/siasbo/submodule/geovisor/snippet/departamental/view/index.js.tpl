...
<script>
    ...
    var snippet_descarga_departamental = function () {
        var btn_descargar_pozos_excel = $('#btn_descargar_pozos_excel');

        var get_descargar_excel = function(id) {
            var url = "{/literal}{$getModule}{literal}&accion=departamental_getDescargarPozosExcel&deptoId={/literal}{$deptoId}{literal}";
    ...
    jQuery(document).ready(function() {
        snippet_descarga_departamental.init();
    });
</script>
{/literal}