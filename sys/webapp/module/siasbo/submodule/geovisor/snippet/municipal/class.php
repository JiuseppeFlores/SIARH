...
class Snippet extends Table {
    ...
    function get_ficha($municipioId) {
    ...
    function get_ficha_epsas($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
    ...
    function get_ficha_anio_perforacion($municipioId, $anio) {
        $sql = "SELECT c.nombre AS departamento, 
        d.nombre AS municipio, 
        b.nombre AS fuente, 
    ...
    function get_ficha_epsas_anio_perforacion($municipioId, $anio) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
    ...
    function get_ficha_profundidad_menor($tipo, $municipioId, $valor) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT c.nombre AS departamento, 
        ...
        vrhr_territorio.departamento c, 
        item_pozo d, 
        vrhr_territorio.municipio e 
        WHERE a.tipo=b.itemId 
        AND a.departamentoId=c.itemId 
        AND a.itemId=d.itemId 
        AND a.municipioId=e.itemId
        AND a.tipo=".$tipo." 
    ...
    function get_ficha_profundidad_mayor($tipo, $municipioId, $valor) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT c.nombre AS departamento, 
        e.nombre AS municipio, 
        b.nombre AS fuente, 
    ...
    function get_ficha_profundidad($tipo, $municipioId, $desde, $hasta) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT c.nombre AS departamento, 
        e.nombre AS municipio, 
        b.nombre AS fuente, 
    ...
    function get_ficha_epsas_profundidad_menor($tipo, $municipioId, $valor) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, item_pozo c 
    ...
    function get_ficha_epsas_profundidad_mayor($tipo, $municipioId, $valor) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, item_pozo c 
    ...
    function get_ficha_epsas_profundidad($tipo, $municipioId, $desde, $hasta) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, item_pozo c 
    ...
    function get_ficha_uso($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.nombre, t2.departamento, t2.municipio, t2.total
        FROM 
        ...
        item c, 
        vrhr_territorio.departamento d, 
        vrhr_territorio.municipio e 
        WHERE b.itemId=c.itemId
        AND c.departamentoId=d.itemId
        AND c.municipioId=e.itemId
        AND c.tipo=1 
        AND c.municipioId=".$municipioId." 
    ...
    function get_ficha_proposito($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.nombre, t2.departamento, t2.municipio, t2.total
        FROM 
        (SELECT itemId, nombre AS nombre 
    ...
    function get_puntos($tipo, $municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_anio_perforacion($tipo, $municipioId, $anio) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_profundidad_menor($tipo, $municipioId, $valor) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_profundidad_mayor($tipo, $municipioId, $valor) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_profundidad($tipo, $municipioId, $desde, $hasta) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_uso($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_proposito($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
         $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_coordenada_min_max($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
    ...
    function get_anio_perforacion($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT
        DATE_FORMAT(b.perforacion_fecha, '%Y') AS anio
        FROM item a, item_pozo b
    ...
    /*function get_datos_pozos($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        ...
        AND a.tipo=1 
        AND a.municipioId=".$municipioId.") t1 
        LEFT JOIN 
        ...
        WHERE a.itemId=b.itemId 
        AND a.tipo=1 
        AND a.municipioId=".$municipioId.") t2 
        ON t1.itemId=t2.id
    ...
    function get_datos_pozos_excel($metadatos, $tituloDocumento, $municipioId) {
        ...
        $respuesta = $this->get_datos_pozos($municipioId);
        ...
        $this->descargar_documento_excel($documentoHojaCalculo, 'pozos_municipal');
    }

    function get_archivo_csv($tituloDocumento, $nombreArchivo, $municipioId) {
