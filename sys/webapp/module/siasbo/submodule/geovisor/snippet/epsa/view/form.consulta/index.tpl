...
<div class="m-portlet__body">
    <div class="row">
        ...
        <div class="col-lg-6">
            <select class="form-control select2" style="width: 100%;" name="epsaId" id="epsaId" required data-msg="Campo requerido. Seleccione una opción.">
                <option value="">Seleccione una opción</option>
                {html_options options=$cataobj.epsa selected=''}
            </select>
        </div>
    </div>
