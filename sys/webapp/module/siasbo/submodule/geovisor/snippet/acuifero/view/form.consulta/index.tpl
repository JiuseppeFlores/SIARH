...
<div class="m-portlet__body">
    <div class="row">
        <div class="col-lg-6">
            <div class="alert m-alert m-alert--default" role="alert">
                Consulta por área o acuífero de referencia.
            </div>
        </div>
        <div class="col-lg-6">
            <select class="form-control select2" style="width: 100%;" name="acuiferoId" id="acuiferoId" required data-msg="Campo requerido. Seleccione un acuífero.">
                <option value="">Seleccione acuífero</option>
                {html_options options=$cataobj.acuifero selected=''}
            </select>
        </div>
    </div>
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-6">
            <select class="form-control select2" style="width: 100%;" name="campaniaId" id="campaniaId" required data-msg="Campo requerido. Seleccione una opción.">
            </select>
        </div>
    </div>
