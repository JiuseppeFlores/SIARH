{include file="consulta.cantidad/municipal/index.css.tpl"}
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					Los siguientes cuadros muestran información de pozos que contienen datos de monitoreo de cantidad a nivel municipal.
				</h3>
...
{include file="consulta.cantidad/municipal/index.js.tpl"}