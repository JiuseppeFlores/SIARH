{include file="consulta.implementacion/departamental/index.css.tpl"}
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					Los siguientes cuadros muestran información de pozos que contienen datos de implementación a nivel departamental.
				</h3>
				<h2 class="m-portlet__head-label m-portlet__head-label--warning">
					<span id="titulo_consulta">Información de Pozos - Datos de implementación</span>
				</h2>
			</div>			
		</div>
	</div>
...
{include file="consulta.implementacion/departamental/index.js.tpl"}