{include file="consulta.hidraulico.recuperacion/nacional/index.css.tpl"}
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					Los siguientes cuadros muestran información de pozos que contienen datos hidráulicos (prueba de recuperación) a nivel nacional.
				</h3>
...
{include file="consulta.hidraulico.recuperacion/nacional/index.js.tpl"}