...
class Snippet extends Table {
    ...
    function get_ficha_epsas_diseno() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        item_pozo c, 
        (SELECT itemId, pozoId 
        FROM item_pozo_constructivo_diseno 
        GROUP BY pozoId) d 
        WHERE a.epsasId=b.itemId 
        AND a.itemId=c.itemId 
        AND c.itemId=d.pozoId 
        AND a.tipo=1 
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
    ...
    function get_ficha_diseno_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b, 
    ...
    function get_ficha_epsas_diseno_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_diseno_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b, 
    ...
    function get_ficha_epsas_diseno_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_litologia() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT c.nombre AS departamento, 
        b.nombre AS fuente, 
        b.itemId AS fuente_id, 
        count(*) AS total 
        FROM item a, catalogo_tipo b, 
        vrhr_territorio.departamento c, 
        (SELECT itemId, pozoId 
        FROM item_pozo_litologica 
        GROUP BY pozoId) d
        WHERE a.tipo=b.itemId 
        AND a.departamentoId=c.itemId 
        AND a.itemId=d.pozoId  
        AND a.tipo=1
    ...
    function get_ficha_epsas_litologia() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_litologia_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_litologia_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_litologia_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_litologia_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_electrico() {
        ...
        WHERE a.itemId=b.itemId  
        AND a.tipo=1
        AND (b.electrico_profundidad <> ''
        OR b.electrico_parametroId <> '')
        LIMIT 1";
        $datos = $this->dbm->Execute($sql);
        $datos = $datos->GetRows();
        return $datos;
    ...
    function get_ficha_epsas_electrico() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        ...
        AND a.itemId=c.itemId  
        AND a.tipo=1 
        AND (c.electrico_profundidad <> ''
        OR c.electrico_parametroId <> '')
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
        $datos = $datos->GetRows();
    ...
    function get_ficha_electrico_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b 
    ...
    function get_ficha_epsas_electrico_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_electrico_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b 
    ...
    function get_ficha_epsas_electrico_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_hidraulico_escalon() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
        FROM item_pozo_hidra 
        GROUP BY pozoId) b, 
        (SELECT itemId, pruebabombeoId 
        FROM item_pozo_hidra_bombeo 
        GROUP BY pruebabombeoId) c, 
        (SELECT itemId, tipobombeoId 
        FROM item_pozo_hidra_bombeo_dato 
        GROUP BY tipobombeoId) d 
        WHERE a.itemId=b.pozoId 
    ...
    function get_ficha_epsas_hidraulico_escalon() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        ...
        (SELECT itemId, pruebabombeoId 
        FROM item_pozo_hidra_bombeo 
        GROUP BY pruebabombeoId) d, 
        (SELECT itemId, tipobombeoId 
        FROM item_pozo_hidra_bombeo_dato 
        GROUP BY tipobombeoId) e 
        WHERE a.epsasId=b.itemId 
        AND a.itemId=c.pozoId 
        AND c.itemId=d.pruebabombeoId 
        AND d.itemId=e.tipobombeoId 
        AND a.tipo=1 
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
    ...
    function get_ficha_hidraulico_escalon_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_hidraulico_escalon_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_hidraulico_escalon_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_hidraulico_escalon_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_hidraulico_recuperacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
        ...
        GROUP BY pruebabombeoId) c, 
        (SELECT itemId, tipobombeoId 
        FROM item_pozo_hidra_recuperacion 
        GROUP BY tipobombeoId) d, 
        (SELECT itemId, recuperacionId 
        FROM item_pozo_hidra_recuperacion_dato 
        GROUP BY recuperacionId) e 
        WHERE a.itemId=b.pozoId 
        AND b.itemId=c.pruebabombeoId 
        AND c.itemId=d.tipobombeoId 
        AND d.itemId=e.recuperacionId 
        AND a.tipo=1 
        LIMIT 1";
        $datos = $this->dbm->Execute($sql);
        $datos = $datos->GetRows();
    ...
    function get_ficha_epsas_hidraulico_recuperacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        ...
        (SELECT itemId, recuperacionId 
        FROM item_pozo_hidra_recuperacion_dato  
        GROUP BY recuperacionId) f 
        WHERE a.epsasId=b.itemId 
        AND a.itemId=c.pozoId 
        AND c.itemId=d.pruebabombeoId 
        AND d.itemId=e.tipobombeoId 
        AND e.itemId=f.recuperacionId 
        AND a.tipo=1 
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
    ...
    function get_ficha_hidraulico_recuperacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_hidraulico_recuperacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_hidraulico_recuperacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_hidraulico_recuperacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_hidraulico_observacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
        ...
        GROUP BY pruebabombeoId) c, 
        (SELECT itemId, tipobombeoId 
        FROM item_pozo_hidra_observacion 
        GROUP BY tipobombeoId) d, 
        (SELECT itemId, observacionId 
        FROM item_pozo_hidra_observacion_dato 
        GROUP BY observacionId) e 
        WHERE a.itemId=b.pozoId 
        AND b.itemId=c.pruebabombeoId 
        AND c.itemId=d.tipobombeoId 
        AND d.itemId=e.observacionId 
        AND a.tipo=1 
        LIMIT 1";
        $datos = $this->dbm->Execute($sql);
        $datos = $datos->GetRows();
    ...
    function get_ficha_epsas_hidraulico_observacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        ...
        (SELECT itemId, observacionId 
        FROM item_pozo_hidra_observacion_dato  
        GROUP BY observacionId) f 
        WHERE a.epsasId=b.itemId 
        AND a.itemId=c.pozoId 
        AND c.itemId=d.pruebabombeoId 
        AND d.itemId=e.tipobombeoId 
        AND e.itemId=f.observacionId 
        AND a.tipo=1 
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
    ...
    function get_ficha_hidraulico_observacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_hidraulico_observacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_hidraulico_observacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_hidraulico_observacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_implementacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b 
    ...
    function get_ficha_epsas_implementacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_implementacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b 
    ...
    function get_ficha_epsas_implementacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_implementacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo b 
    ...
    function get_ficha_epsas_implementacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_cantidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_monitor_cantidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_cantidad_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_monitor_cantidad_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_cantidad_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        (SELECT itemId, pozoId 
    ...
    function get_ficha_epsas_monitor_cantidad_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_calidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo_monitor_calidad b,
        (SELECT itemId, calidadId 
        FROM item_pozo_monitor_calidad_dato 
        GROUP BY calidadId) c
        WHERE a.itemId=b.pozoId 
    ...
    function get_ficha_epsas_monitor_calidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        ...
        (SELECT itemId, calidadId 
        FROM item_pozo_monitor_calidad_dato 
        GROUP BY calidadId) d 
        WHERE a.epsasId=b.itemId 
        AND a.itemId=c.pozoId 
        AND c.itemId=d.calidadId 
        AND a.tipo=1 
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
    ...
    function get_ficha_monitor_calidad_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo_monitor_calidad b,
    ...
    function get_ficha_epsas_monitor_calidad_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_calidad_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo_monitor_calidad b,
    ...
    function get_ficha_epsas_monitor_calidad_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_isotopico() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo_monitor_isotopico b,
        (SELECT itemId, isotopicoId 
        FROM item_pozo_monitor_isotopico_dato 
        GROUP BY isotopicoId) c
        WHERE a.itemId=b.pozoId 
        AND b.itemId=c.isotopicoId 
        AND a.tipo=1
        LIMIT 1";
        $datos = $this->dbm->Execute($sql);
        $datos = $datos->GetRows();
    ...
    function get_ficha_epsas_monitor_isotopico() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
        item_pozo_monitor_isotopico c, 
        (SELECT itemId, isotopicoId 
        FROM item_pozo_monitor_isotopico_dato 
        GROUP BY isotopicoId) d 
        WHERE a.epsasId=b.itemId 
        AND a.itemId=c.pozoId 
        AND c.itemId=d.isotopicoId 
        AND a.tipo=1 
        GROUP BY a.epsasId 
        ORDER BY total DESC";
        $datos = $this->dbm->Execute($sql);
    ...
    function get_ficha_monitor_isotopico_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo_monitor_isotopico b,
    ...
    function get_ficha_epsas_monitor_isotopico_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_ficha_monitor_isotopico_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT count(*) AS total 
        FROM item a, 
        item_pozo_monitor_isotopico b,
    ...
    function get_ficha_epsas_monitor_isotopico_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT b.nombre AS epsa, 
        count(*) AS total 
        FROM item a, catalogo_pozo_general_epsas b, 
    ...
    function get_puntos_diseno_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_diseno_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_litologia_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_litologia_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_electrico_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_electrico_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_escalon() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_escalon_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_escalon_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_recuperacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_recuperacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_recuperacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_observacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_observacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_hidraulico_observacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_implementacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_implementacion_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_implementacion_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_cantidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_cantidad_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_cantidad_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_calidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_calidad_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_calidad_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_isotopico() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_isotopico_departamental($deptoId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    function get_puntos_monitor_isotopico_municipal($municipioId) {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT a.itemId, 
        a.codigo, 
        a.nombre, 
    ...
    //EXPORTA DATOS EN ARCHIVO EXCEL
    //Pozos con datos de construcción
    function get_datos_pozos_diseno() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT itemId, pozoId 
    ...
    //Pozos con datos de litología
    function get_datos_pozos_litologia() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT itemId, pozoId 
    ...
    //Pozos con datos de eléctrico
    function get_datos_pozos_electrico() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId
    ...
    //Pozos con datos hidráulicos (escalones)
    function get_datos_pozos_hidraulico_escalon() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    //Pozos con datos hidráulicos (prueba de recuperación)
    function get_datos_pozos_hidraulico_recuperacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    //Pozos con datos hidráulicos (prueba de observación)
    function get_datos_pozos_hidraulico_observacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    //Pozos con datos de implementación
    function get_datos_pozos_implementacion() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    //Pozos con datos de monitoreo de cantidad
    function get_datos_pozos_monitor_cantidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    //Pozos con datos de monitoreo de calidad
    function get_datos_pozos_monitor_calidad() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    //Pozos con datos de monitoreo de isotópico
    function get_datos_pozos_monitor_isotopico() {
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
        $sql = "SELECT t1.*, t2.*
        FROM 
        (SELECT a.itemId 
    ...
    function get_datos_pozos_excel($metadatos, $tituloDocumento, $tipo_reporte) {
        ...
        switch ($tipo_reporte) {
            case 'rep_diseno':
                $respuesta = $this->get_datos_pozos_diseno();
                $nombreArchivo = 'pozos_datos_constructivos';
                break;

            case 'rep_litologia':
                $respuesta = $this->get_datos_pozos_litologia();
                $nombreArchivo = 'pozos_datos_litologia';
                break;

            case 'rep_electrico':
                $respuesta = $this->get_datos_pozos_electrico();
                $nombreArchivo = 'pozos_datos_perfilaje_electrico';
                break;

            case 'rep_hidraulico_escalon':
                $respuesta = $this->get_datos_pozos_hidraulico_escalon();
                $nombreArchivo = 'pozos_datos_hidraulico_escalon';
                break;

            case 'rep_hidraulico_recuperacion':
                $respuesta = $this->get_datos_pozos_hidraulico_recuperacion();
                $nombreArchivo = 'pozos_datos_hidraulico_recuperacion';
                break;

            case 'rep_hidraulico_observacion':
                $respuesta = $this->get_datos_pozos_hidraulico_observacion();
                $nombreArchivo = 'pozos_datos_hidraulico_observacion';
                break;

            case 'rep_implementacion':
                $respuesta = $this->get_datos_pozos_implementacion();
                $nombreArchivo = 'pozos_datos_implementacion';
                break;

            case 'rep_monitor_cantidad':
                $respuesta = $this->get_datos_pozos_monitor_cantidad();
                $nombreArchivo = 'pozos_datos_monitor_cantidad';
                break;

            case 'rep_monitor_calidad':
                $respuesta = $this->get_datos_pozos_monitor_calidad();
                $nombreArchivo = 'pozos_datos_monitor_calidad';
                break;

            case 'rep_monitor_isotopico':
                $respuesta = $this->get_datos_pozos_monitor_isotopico();
                $nombreArchivo = 'pozos_datos_monitor_isotopico';
                break;
        }
    ...
    function get_archivo_csv($tituloDocumento, $nombreArchivo, $tipo_reporte) {
        // Consulta en la base de datos para obtener datos de pozos
        switch ($tipo_reporte) {
            case 'rep_diseno':
                $respuesta = $this->get_datos_pozos_diseno();
