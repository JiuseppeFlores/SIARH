{include file="consulta.electrico/municipal/index.css.tpl"}
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					Los siguientes cuadros muestran información de pozos que contienen datos de perfilaje eléctrico a nivel municipal.
				</h3>
...
{include file="consulta.electrico/municipal/index.js.tpl"}