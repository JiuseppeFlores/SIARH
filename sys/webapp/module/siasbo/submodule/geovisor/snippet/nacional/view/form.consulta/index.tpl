...
<div class="m-portlet__body">
    <div class="row">
        <div class="col-lg-6">
            <div class="alert m-alert m-alert--default" role="alert">
                Consulta por ubicación política.
            </div>
        </div>
        <div class="col-lg-6">
            <button type="button" class="btn btn-outline-primary btn-sm" id="btn_datos_nacional">Consultar</button>
        </div>
    </div>
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-6">
            <select class="form-control select2-form" style="width: 100%;" name="anio_perforacion" id="anio_perforacion" required data-msg="Campo requerido. Seleccione una opción.">
                <option value="">--Seleccione una opción--</option>
                {html_options options=$anioPerforacion}
            </select>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <select class="form-control select2-form" name="profundidad_perforacion" id="profundidad_perforacion" required data-msg="Campo requerido. Seleccione una opción.">
                <option value="">--Seleccione una opción--</option>
