{include file="grafica_abatimiento/index.css.tpl"}
<!--begin::Gráfica de Abatimiento -->
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Grafica de abatimiento</h5>
...
<!--end::Gráfica de Abatimiento -->
{include file="grafica_abatimiento/index.js.tpl"}