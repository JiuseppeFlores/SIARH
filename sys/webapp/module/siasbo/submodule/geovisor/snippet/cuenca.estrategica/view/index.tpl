			...
			<div class="col-xl-12">
				...
				<div class="m-widget1">
					...
					<div class="m-widget1__item">
						<div class="row m-row--no-padding align-items-center">
							<div class="col text-left">
								<h3 class="m-widget1__title">Pozos por municipio (%)</h3>
								<br>
					...
					<div class="m-widget1__item">
						<div class="row m-row--no-padding">
							<div class="col-md-6 col-lg-12 text-left">
								<h3 class="m-widget1__title">Manantiales por municipio (%)</h3>
								<br>
								<canvas id="manantialChart" width="auto" height="{$manantialCantidadEtiquetas}"></canvas>
							</div>
							<div class="col-md-6 col-lg-12 text-left">
								<h3 class="m-widget1__title">Geofísica por municipio (%)</h3>
								<br>
