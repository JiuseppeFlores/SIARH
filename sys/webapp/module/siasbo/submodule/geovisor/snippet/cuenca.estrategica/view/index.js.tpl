...
<script>
    ...
    var ctx = document.getElementById("pozoChart").getContext('2d');
    var pozoChart = new Chart(ctx, {
        type: 'pie',
        data: {
    ...
    var snippet_descarga_cuenca_estrategica = function () {
        var btn_descargar_pozos_excel = $('#btn_descargar_pozos_excel');

        var get_descargar_excel = function() {
            var url = "{/literal}{$getModule}{literal}&accion=cuenca.estrategica_getDescargarPozosExcel&cuencaEstrategicaId={/literal}{$cuencaEstrategicaId}{literal}";
    ...
    jQuery(document).ready(function() {
        snippet_descarga_cuenca_estrategica.init();
    });
</script>
{/literal}