{literal}
<script>
    var snippet_form_recupera_observa_escalon = function () {
        var idficha = '{/literal}{$id}{literal}';
        var type = '{/literal}{$type}{literal}';
        var form_recupera_observa_escalon = $('#form_recupera_observa_escalon');
        var btn_recupera_observa_escalon_submit = $('#btn_recupera_observa_escalon_submit');

        var campo_input_recupera_observa_escalon = $('#form_recupera_observa_escalon input');
        
        //== Private Functions
        var showRequest= function (formData, jqForm, op) {
            btn_recupera_observa_escalon_submit.addClass('m-loader m-loader--right m-loader--light').attr('disabled', true);
            return true;
        };

        var showResponse = function (responseText, statusText) {
            btn_recupera_observa_escalon_submit.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
        ...
        var options = {
            ...
            , data: {
                accion: '{/literal}{$subcontrol}_itemupdatesqlRecuperaObservaEscalon{literal}'
                ,itemId: idficha
                ,type: type
            }
        };
        ...
        var handle_form_submit = function () {
            form_recupera_observa_escalon.ajaxForm(options);
        };

        var handle_general_form_submit = function () {
            btn_recupera_observa_escalon_submit.click(function (e) {
                e.preventDefault();
                var btn = $(this);
                ...
                form_recupera_observa_escalon.submit();
            });
        };
        ...
        var handle_get_components = function() {
            campo_input_recupera_observa_escalon.keyup(function () {
                form_recupera_observa_escalon.validate();
            });
        };
...
//----------------Permisos--------------------------------------------
    ...
    function permisos_usuario(){
        ...
        jQuery.ajax({
            ...
            success: function(data){
                ...
                //     $("#btn_recupera_observa_escalon_submit").show();
                // }else{
                //     $("#btn_recupera_observa_escalon_submit").hide();
                // }       
    ...
    jQuery(document).ready(function () {
        permisos_usuario();
        snippet_form_recupera_observa_escalon.init();
