{include file="tipo_recuperacion_escalon/grafica_escalon_recuperacion/index.css.tpl"}
<!--begin::Gráfica de Caudal -->
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Grafica de escalones recuperacion</h5>
    ...
    <div class="modal-body">
        ...
        <div id="contenedor">
            <canvas id="lienzorecuperacion" width="750px" height="350px" style="border: solid 1px #e0e0e0;"></canvas>
        </div>
    </div>
...
{include file="tipo_recuperacion_escalon/grafica_escalon_recuperacion/index.js.tpl"}