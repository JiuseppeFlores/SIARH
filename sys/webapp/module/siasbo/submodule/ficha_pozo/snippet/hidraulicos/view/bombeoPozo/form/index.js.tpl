...
<script>
    var snippet_form_bombeo_pozo = function () {
        ...
        var btn_bombeo_pozo_submit = $('#btn_bombeo_pozo_submit');
        
        //== Private Functions
        var showRequest= function (formData, jqForm, op) {
            btn_bombeo_pozo_submit.addClass('m-loader m-loader--right m-loader--light').attr('disabled', true);
            return true;
        };

        var showResponse = function (responseText, statusText) {
            btn_bombeo_pozo_submit.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
        ...
        var options = {
            ...
            , data: {
                accion: '{/literal}{$subcontrol}_itemupdatesqlBombeoPozo{literal}'
                ,itemId: idficha
                ,type: type
            }
        };
        ...
        var handle_general_form_submit = function () {
            ...
            btn_bombeo_pozo_submit.click(function (e) {
                e.preventDefault();
                var btn = $(this);
