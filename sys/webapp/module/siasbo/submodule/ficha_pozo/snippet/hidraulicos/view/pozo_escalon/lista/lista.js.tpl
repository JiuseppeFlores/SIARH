...
<script>
    ...
    function get_tipo() {
        var url = "{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_itemGrillaTipo{literal}&pozoId={/literal}{$pozoId}{literal}&pruebaId={/literal}{$pruebaId}{literal}";
