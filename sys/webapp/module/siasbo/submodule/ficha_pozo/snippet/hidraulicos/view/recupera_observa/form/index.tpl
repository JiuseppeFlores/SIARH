{include file="recupera_observa/form/index.css.tpl"}

<form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST"  action="{$getModule}"  id="form_recupera_observa">
    <input type="hidden" name="item[recuperacionId]" id="recuperacionId" value="{$recuperacionId}">

    <div class="modal-header">
        <h4 class="modal-title">Datos pozo de observacion de recuperación</h4>
    </div>
    ...
    <div class="modal-body">        
        <div class="form-group m-form__group row">
            <div class="col-lg-4">
                ...
                <div class="input-group">
                    <input class="form-control m-input" placeholder="Ingrese fecha" type="text" name="item[fecha]" id="po_fecha" value="{$item.fecha|date_format:'%d/%m/%Y'|escape:"html"}" maxlength="10" data-msg="Campo requerido. Ingrese 10 caracteres con formato dd/mm/aaaa como máximo.">
                </div>
            </div>
        ...
        <div class="form-group m-form__group row ">
            <div class="col-lg-4">
                ...
                <div class="input-group">
                    <input class="form-control m-input" type="text" name="item[utm_este]" id="po_utm_este" placeholder="Ingrese utm este (X)" value="{$item.utm_este|escape:"html"}" min="0" max="999999" step="0.001" data-msg="Campo requerido. UTM este (X) debe contener números, 6 enteros y 3 decimales como máximo.">
                    <div class="input-group-append">
            ...
            <div class="col-lg-4">
                ...
                <div class="input-group">
                    <input class="form-control m-input" type="text" name="item[utm_norte]" id="po_utm_norte" placeholder="Ingrese utm norte (Y)" value="{$item.utm_norte|escape:"html"}" min="0" max="9999999" step="0.001" data-msg="Campo requerido. UTM norte (Y) debe contener números, 7 enteros y 3 decimales como máximo.">
                    <div class="input-group-append">
                        <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Texto. Ej. Texto">
                            <i class="flaticon-questions-circular-button"></i>
                        </span>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-block-custom" id="btn_recupera_observa_submit"><i class="fa fa-check"></i>&nbsp;{if $type == 'new'}Guardar{else}Actualizar{/if}</button>
    </div>
</form>

{include file="recupera_observa/form/index.js.tpl"}