{include file="tipo_escalon/grafica_escalon/index.css.tpl"}
<!--begin::Gráfica de Caudal -->
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Grafica de escalones</h5>
    ...
    <div class="modal-footer">
        <div class="m-btn-group m-btn-group--pill btn-group" role="group" aria-label="First group">
        	...
        	<button type="button" class="btn btn-primary btn-block-custom btn-sm" id="btn_guardar_grafica"><i class="fa fa-save"></i>&nbsp;Guardar imagen</button>
		</div>		
    </div>
<!--end::Gráfica de Caudal -->
{include file="tipo_escalon/grafica_escalon/index.js.tpl"}