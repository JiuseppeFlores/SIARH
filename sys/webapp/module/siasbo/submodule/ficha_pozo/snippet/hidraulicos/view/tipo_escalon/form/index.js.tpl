{literal}
<script>
    var snippet_form_escalon = function () {
        var idficha = '{/literal}{$id}{literal}';
        var type = '{/literal}{$type}{literal}';
        var form_escalon = $('#form_escalon');
        var btn_escalon_submit = $('#btn_escalon_submit');

        var campo_input_escalon = $('#form_escalon input');
        var btn_modal_close = $('#btn_modal_close');
        //== Private Functions
        var showRequest= function (formData, jqForm, op) {
            btn_escalon_submit.addClass('m-loader m-loader--right m-loader--light').attr('disabled', true);
            return true;
        };

        var showResponse = function (responseText, statusText) {
            btn_escalon_submit.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
        ...
        var options = {
            ...
            , data: {
                accion: '{/literal}{$subcontrol}_itemupdatesqlEscalon{literal}'
                ,itemId: idficha
                ,type: type
            }
        };
        ...
        var handle_form_submit = function () {
            form_escalon.ajaxForm(options);
        };

        var handle_general_form_submit = function () {
            btn_escalon_submit.click(function (e) {
                e.preventDefault();
                var btn = $(this);
        ...
        var handle_get_components = function() {
            campo_input_escalon.keyup(function () {
                form_escalon.validate();
            });
    ...
    function permisos_usuario(){
        ...
        jQuery.ajax({
            ...
            success: function(data){
                ...
                //     $("#btn_escalon_submit").show();
                // }else{
                //     $("#btn_escalon_submit").hide();
                // }      
