...
<form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST"  action="{$getModule}"  id="form_isotopico">
    <input type="hidden" name="item[pozoId]" id="iso_pozoId" value="{$pozoId}">
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-4">
                    ...
                    <div class="input-group date">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Se debe anotar la fecha en que se realiza el muestreo."><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group date">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Se debe colocar la hora de muestreo."><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Nombre de la entidad que realizará el muestreo."><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group date">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Fecha en que se realizará los análisis. "><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group date">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Hora en la que se comenzará a realizar dicho análisis."><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Nombre de la entidad de laboratorio que realizará el Análisis."><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Se debe poner un Código de muestreo en laboratorio."><i class="flaticon-questions-circular-button"></i>
                            </span>
                        </div>
                    </div>
                </div>
