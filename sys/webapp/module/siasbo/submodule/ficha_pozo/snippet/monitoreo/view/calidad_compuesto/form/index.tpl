...
<form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST" action="{$getModule}"
    ...
    <div class="modal-body">
        <div class="form-group m-form__group row">
            <div class="col-lg-12">
                ...
                <div class="input-group">
                    <select class="form-control m-input select2" name="item[parametroId]" id="calcom_parametroId"
                        data-msg="Campo requerido. Seleccione un parámetro.">
        ...
        <div class="form-group m-form__group row">
            <div class="col-lg-12">
                ...
                <div class="input-group">
                    <select class="form-control m-input select2" name="item[compuestoId]" id="calcom_compuestoId"
                        data-msg="Campo requerido. Seleccione un compuesto.">
                        <option value="">Seleccione compuesto</option>
                        {if $type == 'update'} {html_options options=$calidad_compuesto selected=$item.compuestoId}
                        {/if}
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="input-group">
                    <input class="form-control m-input" placeholder="Ingrese valor compuesto" type="text"
                        name="item[valor]" id="calcom_valor" value="{$item.valor|escape:"html"}"
                        data-msg="Campo requerido. Valor debe contener números, 4 enteros y 8 decimales como máximo.">
                    <div class="input-group-append">
                        <span class="input-group-text" data-toggle="m-tooltip" data-placement="top" title=""
                            data-original-title="Se pondrá el valor que el laboratorio dio del compuesto a ser seleccionado."><i
        ...
        <div class="form-group m-form__group row ">
            <div class="col-lg-12">
                ...
                <div class="input-group m-input-icon m-input-icon--right">
                    <textarea class="form-control m-input" name="item[observaciones]" id="calcom_observaciones"
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-block-custom" id="btn_calidad_compuesto_submit"><i
