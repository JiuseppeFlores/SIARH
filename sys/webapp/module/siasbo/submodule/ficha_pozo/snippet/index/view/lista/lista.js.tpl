...
<script>
    ...
    function item_opcion_sololeer(id) {
        return '<a href="javascript:item_delete(\''+ id +'\');" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill" title="Solo lectura"><i class="la flaticon-eye m--font-brand"></i></a>';
    }

    function item_opcion_importar(id) {
        return '<a href="javascript:item_import(\''+ id +'\');" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill" title="Importar datos de monitoreo"><i class="la flaticon-upload m--font-brand"></i></a>';
    }
                ...
                jQuery.ajax({
                    ...
                    success: function(data){
                        ...
                        if(obj.res == false){
                            ...
                            swal("Informacion", obj.numfilas+" datos procesados correctamente", "success");
                        }                    
                    },
                    timeout: 20000,
                });
                ...
                if($("#select_Hojas").val() != ""){
                    ...
                    jQuery.ajax({
                        ...
                        success: function(data){
                            ...
                            if (obj.res == true){
                                swal("OK", "La información "+$("#select_Hojas").val()+" guardo <strong>"+obj.filasafectadas+"</strong> registros correctamente", "success");
                                ...
                                swal("ERROR", "La información no se guardo correctamente en PostgreSQL", "error");
                            }
                        },
                    });
                }else{
                ...
                success: function(data) {
                    ...
                    if(data.estado == false) {
                        ...
                        $.each(data.resultado, function(key, registro) {
                            $("#cboHojasArchivoDatosMonitoreo").append(new Option(registro, registro));
                        });
                    } 
                }
            });
            ...
            jQuery.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.estado) {
                        ...
                        $('#cboHojasArchivoDatosMonitoreo').find('[value="' + valorOpcion + '"]').remove();
