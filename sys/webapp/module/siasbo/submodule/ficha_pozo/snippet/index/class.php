...
class Index extends Table {
    ...
    public function get_item_datatable_Rows(){
        ...
        if($_SESSION[userv][usuario] == "admin" || $_SESSION[userv][tipoUsuario] == 1){
            ...
            $extraWhere = "tipo=1 and estado IN ('Registrado', 'Observado', 'Revisado')"; //and userUpdate=".$_SESSION[userv][itemId];
        }else if($_SESSION[userv][tipoUsuario] == 2){
            $extraWhere = "tipo=1 and estado='Registrado'";
        }else if($_SESSION[userv][tipoUsuario] == 3){
            $extraWhere = "tipo=1 and estado IN ('Observado', 'Revisado') and userUpdate=".$_SESSION[userv][itemId];
        }
