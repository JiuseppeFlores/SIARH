...
$grilla_items[]=array(
    "campo" => $field_name
,   "field"=> $field_name
,   "label"=> "Produndidad hasta (m)"
,   "activo"=> 1
);

//-------------------------------------------------------------
$field_name = "rejillafiltroId";
$field_alias = "rejillafiltro";
$field_activo = 1;
$grilla_items[]=array(
    "campo" => "nombre" // nombre del campo pero de la tabla que relaciona
,   "field"=> $field_name
,   "label"=>"Rejilla/Filtro"
,   "as" => $field_name
,   "tabla_alias"=> $field_alias
,   "activo"=> $field_activo
);
        $grilla_tablas[] = array(
            "tabla" => $CFGm->tabla["c_pozo_constructivo_rejillafiltro"]
        ,    "alias"=> $field_alias
        ,   "campo_id"=>"itemId"
