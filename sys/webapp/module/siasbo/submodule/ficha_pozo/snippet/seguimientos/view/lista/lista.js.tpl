...
<script>
    ...
    function itemDeleteActionseguimiento(id) {
        ...
        $.get( "{/literal}{$getModule}{literal}",
            {accion:"columnaseguimiento_itemDelete", random:randomnumber, id:id},
            function(res){
                if(res.res == 1){
    ...
    function get_form_seguimiento(id, type) {
        ...
        $.get(url, function(respuesta) {
            // console.log('url_response::'+respuesta);
    ...
    //     var url = "{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_getGraficaColumnaseguimiento{literal}&id="+id;
    ...
    //     var data = table_list_seguimiento.rows().data();
    //     var dataaux = [];
    ...
    // function DibujarColumnaseguimiento(){        
    //     //Datos();
    //     ConfigurarLienzo();
    ...
    // function DibujarRectanguloLitologia(imagen, posx, posy, anchobloque, altobloque){
    //     var img = new Image();
    ...
    //     Canvas2Image.saveAsPNG(canvas, canvas.width, canvas.height, "Columnaseguimiento");
    // }
