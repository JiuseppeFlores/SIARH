{literal}
    <script>
        ...
        function itemDeleteActionArchivo(id) {
            ...
            {accion:"{/literal}{$subcontrol}_itemDelete{literal}", random:randomnumber, id:id, pozoId:"{/literal}{$pozoId}{literal}"},
            function(res) {
                if (res.res == 1) {
        ...
        function item_opcion_editar_archivo(id) {
            return '<a href="javascript:item_update_archivo(\'' + id +
        ...
        function item_opcion_eliminar_archivo(id) {
            return '<a href="javascript:item_delete_archivo(\'' + id +
        ...
        function item_opcion_descargar_archivo(id) {
            return '<a href="javascript:item_descargar_archivo(\'' + id +
                '\');" class="m-portlet__nav-link btn m-btn m-btn--hover-success m-btn--icon m-btn--icon-only m-btn--pill" title="Descargar"><i class="la flaticon-download m--font-brand"></i></a>';
        }

        function get_form_archivo(id, type) {
            var url = "{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_itemUpdate{literal}&pozoId={/literal}{$pozoId}{literal}&id="+id+"&type="+type;
        ...
        function item_descargar_archivo(id) {
            url= "{/literal}{$getModule}&accion={$subcontrol}_itemDescarga{literal}&pozoId={/literal}{$pozoId}{literal}&id="+id;
        ...
        var initTableArchivo = function() {
            ...
            serverSide: true,
            ajax: {
                url: '{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_getItemList{literal}&pozoId={/literal}{$pozoId}{literal}',
                type: 'POST',
                data: {},
            },
            columns: [
                    ...
                    render: function(data, type, full, meta) {
                        // var boton = '{/literal}
                            ...
                            {if $privFace.editar == 1}
                                ...
                                {literal}' + item_opcion_editar_archivo(data) + '
                            ...
                            {if $privFace.eliminar == 1}
                                ...
                                {literal}' + item_opcion_eliminar_archivo(data) + '
                                    
                                {/literal}
                                
                            {/if}
                            
                            {literal}' + item_opcion_descargar_archivo(data);
                                // return boton;
                                ...
                                var botonedit = "";
                                var botondelete = "";
                                var botondescargas = item_opcion_descargar_archivo(data);
                                //var botonreadonly = "";               
                                            ...
                                            botondelete = '{/literal}
                                                ...
                                                //botonreadonly = '{/literal}
                                                    ...
                                                    {literal}';
                                                        ...
                                                        return botonedit + botondelete + botondescargas; //+botonreadonly;
                                                    },
                                                },
                                                {
                                                    targets: [5, 6, 7],
