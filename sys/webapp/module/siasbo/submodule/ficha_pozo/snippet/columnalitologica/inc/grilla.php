...
,   "activo"=> $field_activo
        ...
        $grilla_tablas[] = array(
            "tabla" => $CFGm->tabla["c_pozo_litologico_permeabilidad"]
        ,    "alias"=> $field_alias
        ,   "campo_id"=>"itemId"
        ,   "relacion_id"=> $field_name
        ,   "activo"=> $field_activo
