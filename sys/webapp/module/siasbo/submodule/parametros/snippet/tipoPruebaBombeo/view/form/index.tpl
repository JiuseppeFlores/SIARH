...
<div class="m-portlet">
    ...
    <form class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST" action="{$getModule}" id="general_form" autocomplete="off">
        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">Catálogo pruebas de bombeo</h3>
                </div>
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            <div class="col-lg-6">
                <label>Nombre</label>                  
                <input class="form-control m-input" placeholder="Ingrese nombre" type="text" name="item[nombre]" id="nombre" value="{$item.nombre|escape:"html"}" maxlength="255" required data-msg="Campo requerido. Ingrese 255 caracteres como máximo.">
            </div>
