...
switch($accion) {
    ...
    default:
        ...
        $grill_list = $subObjItem->get_grilla_list_sbm("grilla_tipoCompuestoCalidad");
    ...
    case 'itemUpdate':
        $menu_tab = $subObjItem->get_item_tab_sbm($type, "tab_tipoCompuestoCalidad");
        ...
        $smarty->assign("id", $id);
        if($type=="update"){
            $item = $subObjItem->get_item($id,"catalogo_pozo_monitor_calidad_compuesto");
    ...
    case 'itemupdatesql':
        //$templateModule = $templateModuleAjax;
        $respuesta = $subObjItem->item_update($item, $itemId, "campos_tipoCompuestoCalidad", $type);
        $core->print_json($respuesta);
        break;
