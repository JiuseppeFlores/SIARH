        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">Catálogo compuestos isotópicos</h3>
                </div>
            </div>
        </div>
        ...
        <div class="m-portlet__body">
            <div class="form-group m-form__group row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control m-input select2" name="item[isotopicoparametroId]" id="isotopicoparametroId" required data-msg="Campo requerido. Seleccione una opción.">
                        <option value="">Seleccione parámetro</option>
                        {html_options options=$cataobj.parametro selected=$item.isotopicoparametroId}
                    </select>
                </div>
            </div>
