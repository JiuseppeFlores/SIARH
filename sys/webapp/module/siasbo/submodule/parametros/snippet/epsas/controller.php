...
switch($accion) {
    ...
    default:
        ...
        //exit();
        //
        $grill_list = $subObjItem->get_grilla_list_sbm("grilla_epsas");
    ...
    case 'itemUpdate':
        ...
        $menu_tab = $subObjItem->get_item_tab_sbm($type, "tab_epsas");

        $smarty->assign("menu_tab", $menu_tab);
        $smarty->assign("menu_tab_active", "general");

        if($type=="update"){
            $item = $subObjItem->get_item($id,"catalogo_pozo_general_epsas"); //epoca
    ...
    case 'itemupdatesql':
        //$templateModule = $templateModuleAjax;
        $respuesta = $subObjItem->item_update($item, $itemId, "campos_epsas", $type); //epoca
        $core->print_json($respuesta);
        break;
