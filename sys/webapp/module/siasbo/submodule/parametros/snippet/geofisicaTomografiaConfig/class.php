...
class Snippet extends Table {
    ...
    public function get_item_datatable_Rows() {
        ...
        $table = $this->tabla["catalogo_geofisica_tomografia_config"];
        /**
         ...
         */
        //$grilla = "index";
        $grilla = "grilla_geofisicaTomografiaConfig";
        /**
    ...
    function item_delete($id) {
        $campo_id = "itemId";
        $res = $this->item_delete_sbm($id, $campo_id, $this->tabla["catalogo_geofisica_tomografia_config"]);
        return $res;
    }
    ...
    function item_update($rec, $itemId, $que_form, $accion) {
         ...
         */
        $campo_id = "itemId";
        $res = $this->item_update_sbm($itemId, $respuesta_procesa, $this->tabla["catalogo_geofisica_tomografia_config"], $accion, $campo_id);
    ...
    function procesa_datos($que_form, $rec, $accion="new") {
        ...
        switch($que_form) {
            case 'campos_geofisicaTomografiaConfig':
                /**
