...
class Snippet extends Table {
    ...
    public function get_item_datatable_Rows() {
        ...
        $table = $this->tabla["catalogo_manantial_usoagua"];
        /**
         ...
         */
        //$grilla = "index";
        $grilla = "grilla_usoAguaManantial";
        /**
    ...
    function item_delete($id) {
        $campo_id = "itemId";
        $res = $this->item_delete_sbm($id, $campo_id, $this->tabla["catalogo_manantial_usoagua"]);
        return $res;
    }
    ...
    function item_update($rec, $itemId, $que_form, $accion) {
         ...
         */
        $campo_id = "itemId";
        $res = $this->item_update_sbm($itemId, $respuesta_procesa, $this->tabla["catalogo_manantial_usoagua"], $accion, $campo_id);
