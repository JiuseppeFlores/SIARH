...
class Snippet extends Table {
    ...
    public function get_item_datatable_Rows() {
        ...
        $table = $this->tabla["catalogo_pozo_monitor_isotopico_parametro"];
        /**
         ...
         */
        //$grilla = "index";
        $grilla = "grilla_tipoParametroIsotopico";
        /**
    ...
    function item_delete($id) {
        $campo_id = "itemId";
        $res = $this->item_delete_sbm($id, $campo_id, $this->tabla["catalogo_pozo_monitor_isotopico_parametro"]);
        return $res;
    }
    ...
    function item_update($rec, $itemId, $que_form, $accion) {
         ...
         */
        $campo_id = "itemId";
        $res = $this->item_update_sbm($itemId, $respuesta_procesa, $this->tabla["catalogo_pozo_monitor_isotopico_parametro"], $accion, $campo_id);
    ...
    function procesa_datos($que_form, $rec, $accion="new") {
        ...
        switch($que_form) {
            case 'campos_tipoParametroIsotopico':
                /**
