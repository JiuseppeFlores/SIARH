...
class Snippet extends Table {
    ...
    public function get_item_datatable_Rows() {
        ...
        $table = $this->tabla["catalogo_pozo_perforacion_metodo"];
        /**
         ...
         */
        //$grilla = "index";
        $grilla = "grilla_metodoPerforacion";
        /**
    ...
    function item_delete($id) {
        $campo_id = "itemId";
        $res = $this->item_delete_sbm($id, $campo_id, $this->tabla["catalogo_pozo_perforacion_metodo"]);
        return $res;
    }
    ...
    function item_update($rec, $itemId, $que_form, $accion) {
         ...
         */
        $campo_id = "itemId";
        $res = $this->item_update_sbm($itemId, $respuesta_procesa, $this->tabla["catalogo_pozo_perforacion_metodo"], $accion, $campo_id);
