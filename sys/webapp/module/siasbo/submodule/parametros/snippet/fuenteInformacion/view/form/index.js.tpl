    ...
    var snippet_general_form = function() {
            ...
            if(responseText.res ==1){
                if(responseText.accion == 'new') {
                    ...
                    swal("Actualizado!", "Se actualizó el registro con éxito!", "success")
                        .then(function() {
                            location = "{/literal}{$getModule}{literal}&accion=fuenteInformacion_index"; //epoca_index
                        });
        ...
        var options = {
            ...
            , data: {
                ...
                accion: 'fuenteInformacion_itemupdatesql'//epoca_itemupdatesql
                ,itemId: idficha
                ,type: type
            }
        };
        ...
        var handle_general_volver = function(){
            general_btn_volver.click(function(){
                location = "{/literal}{$getModule}{literal}&accion=fuenteInformacion_index";
            });
        }
