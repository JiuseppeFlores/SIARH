        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">Catálogo principal</h3>
                </div>
            </div>
        </div>
        ...
        <div class="m-portlet__body">
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-6">
                    ...
                    <input class="form-control m-input" placeholder="Ingrese ruta destino" type="text" name="item[ruta_destino]" id="ruta_destino" value="{$item.ruta_destino|escape:"html"}" maxlength="150" required data-msg="Campo requerido. Ingrese 150 caracteres como máximo.">
                </div>
            </div>
