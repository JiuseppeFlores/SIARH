...
<script>
    ...
    function itemDeleteActionArchivo(id) {
        ...
        $.get( "{/literal}{$getModule}{literal}",
            {accion:"{/literal}{$subcontrol}_itemDelete{literal}", random:randomnumber, id:id, geofisicaId:"{/literal}{$geofisicaId}{literal}"},
            function(res) {
                if(res.res == 1){
    ...
    function get_form_archivo(id, type) {
        var url = "{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_itemUpdate{literal}&geofisicaId={/literal}{$geofisicaId}{literal}&id="+id+"&type="+type;
    ...
    function item_descargar_archivo(id) {
        url= "{/literal}{$getModule}&accion={$subcontrol}_itemDescarga{literal}&geofisicaId={/literal}{$geofisicaId}{literal}&id="+id;
    ...
    var snippet_datatable_list_archivo = function () {
        ...
        var initTableArchivo = function() {
            ...
            table_list_archivo = $('#lista_archivo').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_getItemList{literal}&geofisicaId={/literal}{$geofisicaId}{literal}',
                    type: 'POST',
                    data: {},
                },
                columns: [
