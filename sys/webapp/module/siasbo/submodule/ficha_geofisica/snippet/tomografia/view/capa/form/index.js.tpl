{literal}
<script>
    var snippet_form_tomografia_capa = function () {
        var idfichaCapa = '{/literal}{$id}{literal}';
        var typeCapa = '{/literal}{$type}{literal}';
        var form_tomografia_capa = $('#form_tomografia_capa');
        var btn_tomografia_capa_submit = $('#btn_tomografia_capa_submit');

        var campo_input_tomografia_capa = $('#form_tomografia_capa input');
        
        //== Private Functions
        var showRequest= function (formData, jqForm, op) {
            btn_tomografia_capa_submit.addClass('m-loader m-loader--right m-loader--light').attr('disabled', true);
            return true;
        };

        var showResponse = function (responseText, statusText) {
            btn_tomografia_capa_submit.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
        ...
        var handle_form_submit = function () {
            form_tomografia_capa.ajaxForm(options);
        };

        var handle_general_form_submit = function () {

            btn_tomografia_capa_submit.click(function (e) {
                e.preventDefault();
                var btn = $(this);
        ...
        var handle_get_components = function () {
            campo_input_tomografia_capa.keyup(function () {
                form_tomografia_capa.validate();
            });
        };
    ...
    $('#capa_resistividad').mask('999999.99');
...
//----------------Permisos--------------------------------------------
        ...
        jQuery.ajax({
            ...
            success: function(data){
                ...
                if (obj_permiso[0].crear == 1){                                
                    $("#btn_tomografia_capa_submit").show();
                }else{
                    $("#btn_tomografia_capa_submit").hide();
                }                 
            },
        });
    }
    ...
    jQuery(document).ready(function () {
        permisos_usuario();
        snippet_form_tomografia_capa.init();
