...
<div class="modal-header">
    <h4 class="modal-title">Lista de capas</h4>
</div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-right">
                ...
                <button type="button" class="btn btn-primary btn-block-custom" onclick="javascript:get_form_capa('', 'new');"><span><i class="fa fa-plus"></i><span>&nbsp;Nueva capa</button>
            </div>
        </div>
