...
<script>
    ...
    var snippet_datatable_list = function () {
        ...
        var exporta_titulo = "SIASBO - LISTA DE ESTUDIOS GEOFÍSICOS";
...
//----------------Permisos--------------------------------------------
    ...
    function permisos_usuario(){
        ...
        jQuery.ajax({
            url: '{/literal}{$getModule}{literal}&accion=obtenerPermisos&perpozo=geofisica', //&perpozo=pozo ya no es necesario
            //data: data,
            cache: false,
            contentType: false,
            processData: false,
