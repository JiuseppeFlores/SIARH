...
<script>
    ...
    var canvasCantidad = document.getElementById("lienzo_cantidad");
    ...
    function RecuperarDatosQVST() {
        var url = "{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_getItemCantidad{literal}&manantialId={/literal}{$manantialId}{literal}";
    ...
    function CargarGraficaCaudal(dtc){
        ...
        //AbrirModal();
        var ctx = canvasCantidad.getContext("2d");
        var barChart = new Chart(ctx, {
          ...
          options: {
                ...
                title: {
                    display: true,
                    text: 'Variacion del Caudal - Nombre Manantial: '+dtc[0].nombre,
                },
                scales: {
                    xAxes: [{
                        scaleLabel: {
    ...
    function GuardarGraficaCantidad(){
        Canvas2Image.saveAsPNG(canvasCantidad, canvasCantidad.width, canvasCantidad.height, "MonitoreoCantidad");
    }
