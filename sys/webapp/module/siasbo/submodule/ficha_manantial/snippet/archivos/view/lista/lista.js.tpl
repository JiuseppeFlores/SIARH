...
<script>
    ...
    function itemDeleteActionArchivo(id) {
        ...
        $.get( "{/literal}{$getModule}{literal}",
            {accion:"{/literal}{$subcontrol}_itemDelete{literal}", random:randomnumber, id:id, manantialId:"{/literal}{$manantialId}{literal}"},
            function(res) {
                if(res.res == 1){
    ...
    function get_form_archivo(id, type) {
        var url = "{/literal}{$getModule}{literal}&accion={/literal}{$subcontrol}_itemUpdate{literal}&manantialId={/literal}{$manantialId}{literal}&id="+id+"&type="+type;
    ...
    function item_descargar_archivo(id) {
        url= "{/literal}{$getModule}&accion={$subcontrol}_itemDescarga{literal}&manantialId={/literal}{$manantialId}{literal}&id="+id;
