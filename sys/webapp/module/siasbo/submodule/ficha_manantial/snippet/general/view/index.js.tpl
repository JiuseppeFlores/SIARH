...
//------------------------------------------------------
    ...
    var snippet_general_form = function () {
        ...
        var campo_input_manantial = $('#general_form input');
        ...
        var handle_get_components = function () {
            ...
            campo_input_manantial.keyup(function () {
...
//----------------Permisos--------------------------------------------
    ...
    function permisos_usuario(){
        ...
        jQuery.ajax({
            url: '{/literal}{$getModule}{literal}&accion=obtenerPermisos&perpozo=manantial&type='+type+'&id='+id, //&perpozo=pozo
            //data: data,
            cache: false,
            contentType: false,
            processData: false,
