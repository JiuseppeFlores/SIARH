...
class Index extends Table {
    ...
    public function get_all_rows() {
        ...
        $resultado = [
            ...
            [
                'nombre' => 'CATÁLOGO TIPOS DE SURGENCIA',
                'ruta' => 'siasbo_catalogo_tipo_medio_surgencia'
            ],
            [
                'nombre' => 'CATÁLOGO TIPOS DE PERMANENCIA',
                'ruta' => 'siasbo_catalogo_tipo_permanencia'
            ],
            [
                'nombre' => 'CATÁLOGO TIPOS DE USO DE AGUA',
                'ruta' => 'siasbo_catalogo_tipo_uso_agua'
            ],
            [
            ...
            [
                ...
                'ruta' => 'siasbo_catalogo_tipo_energia'
            ],
            [
            ...
            [
                ...
                'ruta' => 'siasbo_catalogo_tipo_parametro'
            ],
            [
                'nombre' => 'CATÁLOGO TIPOS DE DIRECCIÓN DE LÍNEA BASE',
                'ruta' => 'siasbo_catalogo_tipo_direccion_linea_base'
            ],
            [
